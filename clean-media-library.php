...
Plugin URI:   https://github.com/polsola/clean-media-library
...
if ( !class_exists( 'PS_CleanMediaLibrary' ) ) {
  class PS_CleanMediaLibrary {
    public function __construct() {
      add_filter( 'media_row_actions', array($this, 'add_fix_link'), 10, 1 );
      add_action( 'admin_enqueue_scripts', array($this, 'media_fix_scripts') );
      add_action( 'wp_ajax_ps_fix_attachment', array($this, 'fix_attachment') );
  ...
  $psCleanMediaLibrary = new PS_CleanMediaLibrary();
}
